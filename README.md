...
![CI](https://github.com/revolee/bifrost/actions/workflows/ci.yml/badge.svg)
...
```sh
go install github.com/revolee/bifrost/cmd/bifrost@latest
```

Or download a prebuilt binary from [GitHub Releases](https://github.com/revolee/bifrost/releases).
